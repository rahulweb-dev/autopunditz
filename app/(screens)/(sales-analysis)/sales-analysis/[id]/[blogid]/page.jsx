...
export default async function BlogPage({
  ...
  const image = extractImage(blog.content);
        ...
        <div className="absolute inset-0 z-20 flex items-end">
          ...
          <div className="max-w-6xl mx-auto px-4 pb-12 w-full">
            ...
            <div className="mb-5">
              ...
              <span className="bg-red-500 text-white text-xs uppercase tracking-wider px-4 py-2 rounded-full">
            ...
            {/* TITLE */}
            <h1 className="text-3xl md:text-6xl font-bold text-white leading-tight max-w-5xl mb-6">
      ...
      <div className="max-w-7xl mx-auto px-4 py-14">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8">
            ...
            <article className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-10">
                ...
                {relatedBlogs.map((item) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <h4 className="font-semibold line-clamp-2 group-hover:text-red-500 transition">
